	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<script type="text/javascript" src="//cdn.bootcss.com/jquery.tablesorter/2.22.5/js/jquery.tablesorter.min.js"></script>
			...
			<body>
				<div id="content">
					<h1>XML Sitemap</h1>
					<p class="expl">
						Generated by <a href="http://jekyllrb.com/">Jekyll</a>, this is an XML Sitemap, meant for consumption by search engines.
					</p>
					<p class="expl">
